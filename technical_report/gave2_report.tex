...
provided at this time. All 12 checkpoints used in the final submission are
additionally archived as Kaggle Datasets (\texttt{gave2-task1-7fold-ckpts}
and \texttt{gave2-task2-7fold-ckpts} under the \texttt{aaronajit} account),
independent of the local training hardware.
