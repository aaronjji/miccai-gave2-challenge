...
\textbf{Model size and wall-clock cost.} Task 1 (RRWNet) has 124.13M
parameters (237\,MB checkpoint); Task 2 (CMRRWNet) has 163.30M parameters
(315\,MB checkpoint), the extra $\sim$39M coming from the two additional FFA
encoder branches. Training throughput on the primary T550 GPU is
